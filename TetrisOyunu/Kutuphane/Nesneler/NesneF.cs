...
{
    public class NesneF : Nesne, INesne
    {
        public NesneF(Tablo tablo)
        ...
        {                     
            bool dondu =  
            this.Kutular[0].DondurmekIcinTasi(2, 1) &&
        ...
        public override bool PozisyonSol()
        {
            ...
            this.Kutular[1].DondurmekIcinTasi(1, 3) &&
            this.Kutular[2].DondurmekIcinTasi(2, 3) &&
            this.Kutular[3].DondurmekIcinTasi(3, 3);
            if (dondu)
            {
                this.PanelleriTasi();
            }
        ...
        public override bool PozisyonUst()
        {
            ...
            this.Kutular[2].DondurmekIcinTasi(1, 2) &&
        ...
        {
            bool dondu =
            this.Kutular[0].DondurmekIcinTasi(0, 2) &&
